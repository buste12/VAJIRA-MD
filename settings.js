...
global.owner = process.env.OWNER_NUMBER  || '94717536988' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=CA9DnB6R#Ch6rwrnQsLVORgY7MmukOETUeQdsUQ3r848RCwEKKN0' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "94717536988" : process.env.MODERATORS ,    
